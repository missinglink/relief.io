...
client1.on( 'tweet', function ( tweet ) {
  if( tweet.text.match( /Haiyan|Yolanda|Typhoon|Philippines|Filipina|Pontevedra|RescuePH|ReliefPH|Dead|Injured|Hurt|Help|Aftermath|Storm/i ) ){
...
client1.start(
  ['Haiyan','Yolanda','Typhoon','Philippines','Filipina','#YolandaPH','#Pontevedra','#RescuePH','#ReliefPH'],
