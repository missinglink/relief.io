...
client1.on( 'tweet', function ( tweet ) {
  if( tweet.text.match( /Haiyan|Yolanda|Typhoon|Filipina|Pontevedra|Donate|Flood|Survive|Safety|Airport|Rescue|Relief|Damage|Victim|Injured|Hurt|Help|Aftermath|Storm/i ) ){
