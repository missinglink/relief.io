...
client1.on( 'tweet', function ( tweet ) {
  if( tweet.text.match( /Haiyan|Yolanda|Typhoon|Philippines|Filipina|Pontevedra|Flood|Airport|Rescue|Relief|Dead|Injured|Hurt|Help|Aftermath|Storm/i ) ){
...
client1.start(
  ['Haiyan','Yolanda','Typhoon','Flood','Airport','Relief','Rescue','Philippines','Filipina','#YolandaPH','#Pontevedra'],
