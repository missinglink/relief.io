...
client1.on( 'tweet', function ( tweet ) {
  if( tweet.text && tweet.text.match( /Haiyan|Yolanda|Typhoon|Filipina|Pontevedra|Donate|Flood|Survive|Safety|Airport|Evacuat|Rescue|Relief|Damage|Victim|Injured|Hurt|Help|Aftermath|Storm/i ) ){
...
client1.start(
  ['Haiyan','Yolanda','Typhoon','Flood','Relief','Rescue','Damage','Victim','Donate','#YolandaPH','#Pontevedra'],
